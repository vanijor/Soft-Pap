                            ...
                            <div class="row Pessoa">
                                ...
                                <input type="hidden" name="AltId" required />
                                    <div class="form-group">
                                        <input type="text" class="form-control input-md" placeholder="Nome" name="AltNome" required />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control input-md" placeholder="RG" name="AltRG" required />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control input-md" placeholder="CPF" name="AltCpf" required />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control input-md" placeholder="Telefone" name="AltTelefone" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control input-md" placeholder="Endereço" name="AltEndereco" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control input-md" placeholder="Salario" name="AltSalario" />
                                    </div>
