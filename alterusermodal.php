                        ...
                        <form name="formPessoa" id="formPessoa" method='post'>
                            <div class="row Pessoa">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control input-lg" placeholder="RG" name="RG" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control input-lg" placeholder="CPF" name="Cpf" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="inputText" class="form-control input-lg" placeholder="Login" name="Login" />
                                    </div>

                                    <div class="form-group">    
                                        <input type="password" id="inputPass" class="form-control input-lg" placeholder="Senha" name="Senha" />
                                    </div>
